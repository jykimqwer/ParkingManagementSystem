...
gantt
	...
	section Backlog 추가 개발
		...
		사전정산 프로그램 및 실시간 정산프로그램 연동 : 2024-02-27 2d
		관리자 프로그램 차량조회 추가 구현 : 2024-02-28 1d
		STM 추가 구현(2Way) : 2024-02-28 1d
		주차장 시나리오 최종 구현 : 2024-02-28 1d

	section 최종 테스트 및 영상 제작
		최종 테스트 및 디버깅 : 2024-02-29 1d
